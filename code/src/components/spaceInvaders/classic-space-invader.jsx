...
const ClassicSpaceInvaders = () => {
			...
			<div className="space-invaders-game-container">
				<div className="space-invaders-game-over-screen">
					...
					<div className="space-invaders-buttons">
						<Link
							className="space-invaders-menu-button"
							to={"/"}
						>
							Menu
						</Link>
	...
	return (
		<div className="space-invaders-game-container">
			{/* Nivel mostrado */}
			<div className="space-invaders-level-display">Level {level}</div>

			<div className="space-invaders-canvas">
				<div className="space-invaders-player" style={{ left: player.x, top: player.y }}></div>
				...
				{enemyBullets.map((bullet, index) => (
					<div
						key={index}
						className="space-invaders-bullet space-invaders-enemy-bullet"
						style={{ left: bullet.x, top: bullet.y }}
					></div>
				))}
